...
Getting Started: Retargeting Instructions
Follow these steps immediately after cloning or downloading the repository to ensure a smooth setup:

1. Open the Solution: Launch your recommended code editor (see below) and open the solution file (.sln).

2. Access Retargeting (Visual Studio):

3. In Solution Explorer, right-click the Solution node (the top item, usually named after the project).

4. Select Retarget Solution or Retarget Projects (the exact wording may vary slightly depending on your IDE version).
